...
class MyWidget(QMainWindow):
    ...
    def timeSeriesGeneration():
        """
        Generating Time Series For Export
        """

    """
    # Attempting to change position of dialogue box
    def openDialog(self, title, prompt):
        ...
        widget_x, widget_y = widget_pos.x(), widget_pos.y()
        ...
        input = simpledialog.askstring(title = title, prompt = prompt)
